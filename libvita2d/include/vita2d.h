...
int vita2d_font_draw_text_advanced(vita2d_font *font, int x, int y, float line_space, float letter_spacing, unsigned int color, unsigned int size, const char *text);
int vita2d_font_draw_textf_advanced(vita2d_font *font, int x, int y, float line_space, float letter_spacing, unsigned int color, unsigned int size, const char *text, ...);
...
int vita2d_pgf_draw_text_advanced(vita2d_pgf *font, int x, int y, float line_space, float letter_spacing, unsigned int color, float scale, const char *text);
int vita2d_pgf_draw_textf_advanced(vita2d_pgf *font, int x, int y, float line_space, float letter_spacing, unsigned int color, float scale, const char *text, ...);
...
int vita2d_pvf_draw_text_advanced(vita2d_pvf *font, int x, int y, float line_space, float letter_spacing, unsigned int color, float scale, const char *text);
int vita2d_pvf_draw_textf_advanced(vita2d_pvf *font, int x, int y, float line_space, float letter_spacing, unsigned int color, float scale, const char *text, ...);
